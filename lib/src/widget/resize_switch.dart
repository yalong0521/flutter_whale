...
///
/// {@tool dartpad}
/// This example shows a toggleable [AppSwitch]. When the thumb slides to
...
/// {@tool snippet}
///
/// This sample shows how to use a [AppSwitch] in a [ListTile]. The
...
class AppSwitch extends StatefulWidget {
  ...
  /// {@template flutter.cupertino.AppSwitch.applyTheme}
  ...
  /// {@template flutter.cupertino.AppSwitch.dragStartBehavior}
    ...
    return MouseRegion(
      ...
      child: Opacity(
        ...
        child: FocusableActionDetector(
          ...
          child: _AppSwitchRenderObjectWidget(
            value: widget.value,
...
class _AppSwitchRenderObjectWidget extends LeafRenderObjectWidget {
  const _AppSwitchRenderObjectWidget({
    required this.value,
  ...
  @override
  _RenderAppSwitch createRenderObject(BuildContext context) {
    return _RenderAppSwitch(
      value: value,
      activeColor: activeColor,
  ...
  @override
  void updateRenderObject(BuildContext context, _RenderAppSwitch renderObject) {
...
const double _kTrackWidth = _kSwitchWidth;
const double _kTrackHeight = _kSwitchHeight;
...
const double _kSwitchHeight = 35.4;
...
class _RenderAppSwitch extends RenderConstrainedBox {
  _RenderAppSwitch({
    required bool value,
